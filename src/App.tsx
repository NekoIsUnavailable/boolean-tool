    ...
    <div className="min-h-screen bg-slate-100 p-4 md:p-8 font-sans text-slate-900">
      <div className="max-w-6xl mx-auto space-y-6">
        <header className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold text-slate-800 tracking-tight">Boolean Minimizer</h1>
            <p className="text-slate-500 mt-1">Visual Logic Simplification</p>
          </div>
          <div className="flex gap-2 w-full sm:w-auto">
            {isInstallable && (
              <button 
                onClick={handleInstallClick}
                className="flex-1 sm:flex-none flex justify-center items-center gap-2 px-4 py-2 bg-indigo-600 text-white font-semibold rounded-lg shadow-sm border border-indigo-700 hover:bg-indigo-700 transition-colors"
              >
                Install App
              </button>
            )}
            <button 
              ...
              className="flex-1 sm:flex-none flex justify-center items-center gap-2 px-4 py-2 bg-white text-slate-700 font-semibold rounded-lg shadow-sm border border-slate-200 hover:bg-slate-50 transition-colors"
            >
              History
            </button>
          </div>
